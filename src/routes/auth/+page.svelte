				...
				{:else}
					<div class="my-auto flex flex-col justify-center items-center">
						<div class=" sm:max-w-md my-auto pb-10 w-full dark:text-gray-100">
							...
							<div class="mt-6 border-t border-gray-700/10 dark:border-gray-100/10 pt-4">
								<button
									class="flex justify-center items-center text-xs w-full text-center text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white transition underline"
									type="button"
									on:click={() => {
								...
								>
									<span>{$i18n.t('Change Backend URL')} ({WEBUI_BASE_URL})</span>
								</button>
							</div>
						</div>
